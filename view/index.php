...
$sql = "SELECT SUM(total_bayar) as total FROM transaksi WHERE status = 'dibayar'";
$statement = $koneksi->prepare($sql);
$statement->execute();
$total_pemasukan = $statement->fetchColumn();

$sql = "SELECT COUNT(*) as count FROM transaksi WHERE status = 'dibayar'";
$statement = $koneksi->prepare($sql);
$statement->execute();
$total_order = $statement->fetchColumn();

$sql = "SELECT COUNT(*) as count FROM anak";
$statement = $koneksi->prepare($sql);
$statement->execute();

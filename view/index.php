...
<ul class="nav nav-tabs justify-content-center mb-5">
    <li class="nav-item">
        <a class="nav-link <?= (isset($_GET['chart']) ? $_GET['chart'] : 'penjualan') == 'penjualan' ? 'active' : '' ?>" href="index.php?chart=penjualan">Chart Penjualan</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?= (isset($_GET['chart']) ? $_GET['chart'] : 'penjualan') == 'pemasukan' ? 'active' : '' ?>" href="index.php?chart=pemasukan">Chart Pemasukan</a>
    </li>
    <li class="nav-item">
        <a class="nav-link <?= (isset($_GET['chart']) ? $_GET['chart'] : 'penjualan') == 'pengeluaran' ? 'active' : '' ?>" href="index.php?chart=pengeluaran">Chart Pengeluaran</a>
    </li>
</ul>
    <?php endif; ?>
